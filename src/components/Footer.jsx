                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12 text-center md:text-left">
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 text-sm text-gray-500 font-medium">
                            ...
                            <li><Link to="/shop?category=montre-arabe" className="hover:text-white transition">Montre Arabe</Link></li>
                            <li><Link to="/shop?category=montre-poedagar" className="hover:text-white transition">Montre Poedagar</Link></li>
