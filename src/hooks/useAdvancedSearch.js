...
export function useAdvancedSearch({ lang, onSearchResults }) {
    ...
    const spellingCorrections = useMemo(() => ({
        ...
        'hat': 'hat', 'chapeau': 'hat', 'cap': 'cap', 'casquette': 'cap', 'fedora': 'fedora',
        'baseball': 'baseball', 'snapback': 'snapback', 'beanie': 'beanie', 'bonnet': 'beanie',
        'one piece': 'one piece', 'luffy': 'luffy', 'ace': 'ace', 'law': 'law', 'anime': 'anime',
        'straw hat': 'straw hat', 'flame': 'flame', 'fire': 'fire', 'surgeon': 'surgeon',
        'chopper': 'chopper', 'tony': 'tony', 'blue': 'blue', 'mugiwara': 'mugiwara'
    }), []);
