...
// Each category contains an array of items with bilingual descriptions and image paths
...
const products = [
    {
        ...
        items: [
            {
                name: "Black Arabic Numeral Watch",
                description: {
            ...
            {
                name: "Black Silver Arabic Numeral Watch",
                description: {
            ...
            {
                name: "White Arabic Numeral Watch",
                description: {
            ...
            {
                name: "Camo Arabic Numeral Watch",
                description: {
            ...
            {
                name: "Gray Camo Arabic Numeral Watch",
                description: {
            ...
            {
                name: "Transparent Arabic Numeral Watch",
                description: {
            ...
            {
                name: "Green Arabic Numeral Watch",
                description: {
            ...
            {
                name: "Brown Shemagh Arabic Watch",
                description: {
            ...
            {
                name: "Light Gray Minimalist Watch",
                description: {
            ...
            {
                name: "White Greek Numeral Watch",
                description: {
